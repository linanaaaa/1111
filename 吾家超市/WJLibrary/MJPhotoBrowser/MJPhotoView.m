...
- (void)adjustFrame
{
    ...
    if (imageWidth > imageHeight) {
        maxScale = boundsHeight / imageHeight;
    }
...
- (void)scrollViewDidZoom:(UIScrollView *)scrollView
{
    ...
    if (scrollView.zoomScale == scrollView.minimumZoomScale) {
        centerX = scrollView.frame.size.width * 0.5;
        centerY = scrollView.frame.size.height * 0.5;
    }
    else {
        centerX = scrollView.contentSize.width * 0.5;
        centerY = scrollView.contentSize.height * 0.5;
    }
