...
@interface WJBannerScrollView ()<UIScrollViewDelegate>
{
    NSInteger pageCount;
...
@implementation WJBannerScrollView
...
-(void)initUI
{
    ...
    self.pageControl.frame = CGRectMake(kScreenW - 80, self.scrollView.frame.size.height - 30, 50, 30);
...
-(UIPageControl *)pageControl
{
    ...
    _pageControl.pageIndicatorTintColor =  kColor(153, 153, 153);       // 选中
    _pageControl.currentPageIndicatorTintColor = [UIColor whiteColor];  // 底色
