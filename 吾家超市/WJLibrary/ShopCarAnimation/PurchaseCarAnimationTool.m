...
@interface PurchaseCarAnimationTool ()<CAAnimationDelegate,UIApplicationDelegate>
@end
#else

@interface PurchaseCarAnimationTool ()<UIApplicationDelegate>
@end
#endif
...
-(void)startAnimationandView:(UIView *)view andRect:(CGRect)rect andFinisnRect:(CGPoint)finishPoint andFinishBlock:(animationFinisnBlock)completion
{
    ...
    [path addQuadCurveToPoint:finishPoint controlPoint:CGPointMake(10, rect.origin.y-80)];
